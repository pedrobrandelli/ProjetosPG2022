...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(width/4, height*0.75f, 0.0f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(100.0f, 100.f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));

		shader.setVec4("inputColor",1.0f, 0.5f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLES, 0, 3);

		shader.setVec4("inputColor",1.0f, 0.0f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor
		glDrawArrays(GL_LINE_LOOP, 0, 3);

		//-------------------------------------------------------
		
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(width*0.75f, height/2, 0.0f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(200.0f, 200.0f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));

		shader.setVec4("inputColor", 1.0f, 1.0f, 0.8f, 1.0f); //enviando cor para variável uniform inputColor
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLES, 0, 3);
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(width/2, height/4, 0.0f));
		model = glm::scale(model, glm::vec3(150.0f, 150.f, 1.0f));
		shader.setMat4("model", glm::value_ptr(model));

		shader.setVec4("inputColor", 0.0f, 1.0f, 0.0f, 1.0f); //enviando cor para variável uniform inputColor
		glBindVertexArray(VAO);
		glDrawArrays(GL_TRIANGLES, 0, 3);
